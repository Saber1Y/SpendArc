...
contract SpendArcPaymaster is BasePaymaster {
        ...
        returns (bytes memory context, uint256 validationData)
    {
        ...
        require(signature.length == 64 || signature.length == 65, "SpendArcPaymaster: invalid signature length");
