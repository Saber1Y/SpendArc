    ...
    <div className="flex min-h-screen bg-surface-muted">
      ...
      <aside className="fixed inset-y-0 left-0 z-40 flex w-[var(--sidebar-width)] flex-col bg-surface-sidebar">
        ...
        <div className="flex h-16 items-center gap-2.5 px-5">
          ...
          <div>
            <span className="text-sm font-semibold text-white tracking-tight">SpendArc</span>
            <span className="block text-[10px] text-white/40 leading-none mt-0.5">Agent Spending Control Plane</span>
          </div>
        </div>
        ...
        <div className="mx-4 mb-4">
          <div className="flex items-center gap-2 rounded-lg bg-white/5 px-3 py-2">
            <span className="h-1.5 w-1.5 rounded-full bg-state-approved animate-pulse" />
            <span className="text-[11px] text-white/60 font-medium">Arc Testnet</span>
          </div>
        </div>
